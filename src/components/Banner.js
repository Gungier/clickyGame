...
const Banner = props => (
  <article style={style.bgDark} className="mw7 center ph3 ph5-ns tc br2 pv3 bg-black-90 mb5 animated fadeIn">
    <img style={style.logoIcon} className='logoIcon' src="https://3.bp.blogspot.com/-GsXg38aYhaM/U3nxfhh-aGI/AAAAAAAAE58/M-xecKXgsrQ/s1600/zelda_animated.gif" alt="castlevania"/>
